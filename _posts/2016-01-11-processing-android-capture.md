...
正因为如此，我就决定开发一个processing和android交互的库，供大家来使用，同时，**作为一个只用processing从来就没给[foundation](https://github.com/processing)捐赠过的人，写这样一个lib来为社区做点贡献，这样心里应该会好过点吧。。。**
...
Δ  android客户端 登录服务器界面（地址为processing 服务端的本地ip地址，pc端cmd进入命令行模式，输入ipconfig即可查看本地局域网ip地址）
...
## 使用方法
1. 首先你需要在github上去下载AndroidCaptureForProcessing.jar及android客户端app  
